        ...
        <div className="max-w-(--breakpoint-xl) mx-auto py-16 px-6 xl:px-0">
            <div className="grid lg:grid-cols-3 gap-12 items-start">
                ...
                <div className="lg:col-span-1">
                    <span className="text-pink-500 font-bold tracking-widest text-xs uppercase">Upcoming</span>
                    <h2 className="text-3xl md:text-4xl font-bold tracking-tight mt-3 text-foreground mb-6">
                        Upcoming courses
                    </h2>
